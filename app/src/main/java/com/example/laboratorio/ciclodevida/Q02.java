...
public class Q02 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textPrimeiraLetra = (TextView) findViewById(R.id.textPrimeiraLetra);
        textUltimaLetra = (TextView) findViewById(R.id.textUltimaLetra);

    }

public void questao2PrimeiraUltimaLetra(View view) {
    int tamanho = edCampoPalavra.getText().toString().length();

    if(tamanho < 5)
        Toast.makeText(Q02.this,
                "Informe uma palavra maior que 5 caracteres!",
